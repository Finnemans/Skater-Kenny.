...
struct Main{
  ...
  void loadLevel(int x_offset = 0) {
    ...
    if (level == 1) {
      ...
      platforms.emplace_back("platform", 650 + x_offset, 340);
      platforms.emplace_back("platform", 850 + x_offset, 360);

      platforms.emplace_back("block", 1000 + x_offset, 350);
      if (SDL_rand(2) == 1) cones.emplace_back(1000 + x_offset, 350 - 12);

      platforms.emplace_back("block", 1150 + x_offset, 330);
      platforms.emplace_back("block", 1250 + x_offset, 300);
      platforms.emplace_back("block", 1350 + x_offset, 270);

      platforms.emplace_back("platform", 1500 + x_offset, 290);

      platforms.emplace_back("rail", 1650 + x_offset, 260);
      platforms.emplace_back("rail", 1900 + x_offset, 300);

      platforms.emplace_back("platform", 2150 + x_offset, 340);
      platforms.emplace_back("platform", 2350 + x_offset, 310);
      platforms.emplace_back("platform", 2550 + x_offset, 340);
      platforms.emplace_back("platform", 2750 + x_offset, 310);

      platforms.emplace_back("platform", 2950 + x_offset, 330);
      if (SDL_rand(2) == 1) cones.emplace_back(3085 + x_offset, 330 - 12);
      platforms.emplace_back("platform", 3150 + x_offset, 350);

      platforms.emplace_back("block", 3300 + x_offset, 340);
      platforms.emplace_back("block", 3450 + x_offset, 320);
      platforms.emplace_back("block", 3650 + x_offset, 340);
      if (SDL_rand(2) == 1) cones.emplace_back(3700 + x_offset, 340 - 12);

      platforms.emplace_back("platform", 3825 + x_offset, 360);
      if (SDL_rand(2) == 1) cones.emplace_back(3945 + x_offset, 360 - 12);
      platforms.emplace_back("platform", 3950 + x_offset, 340);

      platforms.emplace_back("block", 4150 + x_offset, 320);
      platforms.emplace_back("block", 4300 + x_offset, 290);
      if (SDL_rand(2) == 1) cones.emplace_back(4400 + x_offset, 290 - 12);
      platforms.emplace_back("block", 4450 + x_offset, 260);

      platforms.emplace_back("platform", 4675 + x_offset, 375);
      platforms.emplace_back("platform", 4900 + x_offset, 365);
    }
  }
